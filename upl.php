...
<br>
<div class="card">
<p>The upload is used to insert only JSON files in the VIEW folder, after which they are selected and displayed in the SELECT page.</p>
</div>
<form action="u.php" method="post" enctype="multipart/form-data">
<div class="form-group">
<label for="upload"><h2>Upload:</h2></label>
<input type="file" name="file" id="fileToUpload" class="form-input">
</div>
<br>
<div class="btn-group">
<div align="center">
<input type="submit" value="Upload" name="submit" class="btn-10">
</div>
</div>
</form>
<br><br>
