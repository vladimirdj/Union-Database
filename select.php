...
<br>
<div class="card">
<p>Select is used to select the json file that we previously uploaded and set the data in the JSON file to:</p>
...
<div class="btn-group">
<div align="center">
<input type="submit" name="submit" value="Submit Option!" class="btn-9"></form>
</div>
</div>
<br><br>
<?php
