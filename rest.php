...
<link rel="stylesheet" href="css/moj2.css">
<style>
body {
margin: 0;
padding: 0;
...
<div class="card">
<p>Url is used to insert a url containing JSON files.
Example: test.com/test1.json The address needs to contain a JSON file. After that you have to adjust Json by form:</p>
<h3>Elements for JSON file</h3>
<ul>
<li>firts_name</li>
<li>last_name</li>
<li>korisnik - (user)</li>
...
<input type="url" name="username" class="form-input">
<br><br>
</div>
<div class="btn-group">
<input type="submit" name="submit" value="Send" class="btn-11">
</form>
</div>
<br>
<div alig="center">
...
$get = file_get_contents($_POST['username']);
