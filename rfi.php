...
<form action="rfi1.php" method="post">
<div class="form-group">
<label for="thread_title"><h2> New file name:  <h2> </label>
<input type="text" id="thread_title" class="form-input" name="nefiles" value="<?php echo $files; ?>">
</div>
<input name="files" type="hidden" value="<?php echo $files; ?>"></td>
<div align="center">
<div class="btn-group">
<button class="btn-5" type="submit" name="submit">Rename</button>
</div>
</div>
</form>
<br><br>
