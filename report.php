...
<br>
<p>Report serves us to extract reports from the JOSN database. We do this by entering the URL JSON file and entering the required data from the JSON fatabasha. For example (frst_name, last_name, email,...) When we have entered it and press go name, everyone will be presented in the result page and we can print it or transfer it to Excel as well as to a PDF file.</p>
<p>If you need a more complex report with multiple columns, you can do so on the Ekample page. Here you can create or upload a json file and you can create report fields on it. Creating fields for the report is done on the folder / edit page where you select ČRUD / se.php where you can add or subtract fields or mountains that you will take from the foilder page. It is important to note that when creating forms, pay attention to the names in the form name = "row1_name", name = "row2_name", .. and and combine with data from JSON.</p>
<h3>URL:<h3>
<ul>
<li> http://www.sensationenergy.com/test2/tutorial/funkcija/union_database/user.json</li>

</ul>
<h3>Rows<h3>
<ul>

<li> row1_name: first_name </li>
<li> row2_name: last_name </li>
<li>row3_name: korsinik </li>
<li>row4_name: email </li>
</ul>
<p>We are user "user.json" table and  row1_first_name, row2_last_name, row3_korsink, row4_email </p>
