...
<label for="thread_title"><h2>New name:</h2></label>
<?php include 'rich.php'; ?>
<textarea name="name" style="width:100%; height:30%;" id="poruke_sadrzaj" class="form-input"></textarea>
<br><br>
<input name="files" type="hidden" value="<?php echo $files; ?>"></td>
<div align="center">
<input type="submit" class="btn-10" name="submit" value="Edit">
</div>
</form>
<br><br>
