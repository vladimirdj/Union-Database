...
echo $dir;
?></h2>
<form action="rfo.php" method="post">
<div class="form-group">
<label for="thread_title"><h2>Folder:</h2></label>
<input type="text" id="thread_title" class="form-input" name="newdir" value="<?php echo $dir; ?>">
</div>
<input name="dir" type="hidden" value="<?php echo $dir; ?>"></td>
<br>
<div class="btn-group">
<button class="btn-3" type="submit" name="submit">Change</button>
</div>
</form>
<br><br>
