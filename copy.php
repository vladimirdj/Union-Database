...
<br>
<div align="center">
<h2>Copy files from folder to folder</h2>
</div>
<br>
...
<div>
<select name="folders" id="folders" class="form-input">
<?php
$dirs = array_filter(glob('view/*'), 'is_dir');
...
<br>
<input name="folder" type="hidden" value="<?php echo $folder; ?>"></td>
<div align="center">
<div class="btn-group">
<button class="btn-4" type="submit" name="ubaci">Copy file</button>
</div>
</div>
</form>
<br>
