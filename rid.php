...
<br>
<div class="card">
<p>ID allows us to when we insert an ID from a JSON file and press the GO button! lists all files and from JOŠN files that are related to the ID we entered. And set the data in the JSON file to:</p>
...
<lable>ID</lable>
<input type="text" id="title"  name="user_id"  class="form-input" required  /></td>
</div>
<br>
